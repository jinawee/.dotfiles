...
xkb_symbols "basic" {
    ...
    key <AD11>	{ [braceleft, dead_circumflex, bracketleft, dead_abovering ] };
    key <AD12>	{ [      plus,   asterisk, bracketright,  dead_macron ]	};

    key <AC10>	{ [ colon, semicolon,ntilde, dead_doubleacute ]	};
    key <TLDE>	{ [ masculine, ordfeminine,    backslash,   backslash ]	};
    key <AC11>	{ [dead_acute, dead_diaeresis, braceleft,   braceleft ]	};
    key <AC44>	{ [j, J, backslash ]	};// no funca

    key <BKSL>	{ [  braceright,   Ccedilla,   braceright,   dead_breve ]	};
